        ...
        try:
            with open(self.path, "r+") as file:
                ...
                for line in file.readlines():
                    ...
                    if mid_delimiter in line and keep_else_content:
...
class RKScrubber():
    ...
    def __init__(self):
        ...
        self.json_files_to_remove = ["ORKAVJournalingStep.json", "ORKAVJournalingResult.json", "ORKAVJournalingPredefinedTask.json", "ORKTinnitusPredefinedTask.json", "ORKTinnitusUnit.json", "ORKTinnitusTypeStep.json", "ORKTinnitusTypeResult.json", "ORKTinnitusVolumeResult.json", "ORKTinnitusPureToneStep.json", "ORKTinnitusPureToneResult.json", "ORKTinnitusMaskingSoundStep.json", "ORKTinnitusMaskingSoundResult.json", "ORKTinnitusOverallAssessmentStep.json", "ORKTinnitusOverallAssessmentResult.json", "ORKBLEScanPeripheralsStep.json", "ORKBLEScanPeripheralsStepResult.json", "ORKSpeechInNoisePredefinedTask.json", "ORKHeadphoneDetectStep.json", "ORKHeadphoneDetectResult.json", "ORKHeadphonesRequiredCompletionStep.json", "ORKFaceDetectionStep.json", "ORKVolumeCalibrationStep.json", "ORKdBHLToneAudiometryCompletionStep.json", "ORKFamilyHistoryResult.json", "ORKFamilyHistoryStep.json", "ORKRelativeGroup.json", "ORKHealthCondition.json", "ORKRelatedPerson.json", "ORKConditionStepConfiguration.json", "ORKIdBHLToneAudiometryStep.json", "ORKISpeechInNoiseStep.json","ORKIEnvironmentSPLMeterStep.json","ORKISpeechRecognitionStep.json","ORKICompletionStep.json","ORKIInstructionStep.json","ORKIdBHLToneAudiometryResult.json","ORKIQuestionStep.json","ORKTypingStep.json","ORKTypingResult.json","mapper_navigableTaskExample1.json", "mapper_ras_acute_environment.json", "ORKIOrderedTask.json", "ORKINavigableOrderedTask.json","ORKIdBHLToneAudiometryFrequencySample.json","ORKdBHLToneAudiometryMethodOfAdjustmentInteraction.json", "ORKdBHLToneAudiometryMethodOfAdjustmentStep.json","ORKSelectableHeadphoneDetectorPredefinedTask.json","ORKSettingStatusStep.json","ORKSettingStatusResult.json"]
...
class RKCatalogScrubber():
    def __init__(self):
        ...
        self.folders_to_remove = ["Scrubbers", "List1", "PracticeList", "QuestionList1", "TinnitusSounds1","promo_image.imageset", "InternalUITests", "TaskExamples"]
