...
@protocol ORKFlamesViewProviding;
@protocol ORKFlamesViewProvidingDelegate <NSObject>
@required
...
@end
@protocol ORKFlamesViewProviding <NSObject>
/**
 ...
 */
@property (nullable, nonatomic, weak) id<ORKFlamesViewProvidingDelegate> flamesDelegate;
/**
